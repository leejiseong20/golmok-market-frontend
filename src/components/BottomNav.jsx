...
export default function BottomNav({ onHome, onRegionClick, onMyPage, onChat, view, user, onLogin, onLogout, loggingOut }) {
  ...
  return <nav className={styles.wrap + " " + styles.nav} aria-label="모바일 메뉴"><div className={styles.tabs}>
    ...
    <button className={tab(view === "chat")} onClick={onChat} aria-current={view === "chat" ? "page" : undefined}><span className={styles.icon}>◌</span>채팅</button>
