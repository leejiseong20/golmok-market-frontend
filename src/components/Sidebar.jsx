...
export default function Sidebar({ onRegionClick }) {
  return <aside className={styles.aside}><div className={styles.sticky}>
    <div className={styles.panel}><h2 className={styles.h2}>가까운 이웃의 물건을 찾아보세요</h2>
      <p className={styles.promoP}>동네를 선택하고 필요한 물건을 검색해 보세요. 카테고리와 가격순 정렬로 더 쉽게 찾을 수 있어요.</p>
      <button className={styles.promoBtn} onClick={onRegionClick}>동네 선택하기</button>
    </div>
    <div className={styles.panel}><h2 className={styles.h2}>거래 전 확인하세요</h2>
